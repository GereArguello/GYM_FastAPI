...
Revision ID: 13d982f9cbc4
Revises: 
Create Date: 2026-01-23 19:08:44.355931
...
def upgrade() -> None:
    ...
    sa.Column('is_active', sa.Enum('ACTIVE', 'INACTIVE', name='statusenum'), nullable=False),
